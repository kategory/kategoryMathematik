...
Wir betrachten die Kategorie aller Morphismen, die der Morphismen über bzw. unter einem Objekt. Dabei fällt auf, dass es eigentlich bestimmte Figuren sind, die wir zur Kategorie machen.

Das greifen wir auf und bilden die Kategorie der Paare von Objekten auf die gleiche Weise. Wir erkennen, dass wir eigentlich mit Funktoren hantieren. Wir bilden also Morphismen zwischen Funktoren. Diese werden \textbf{natürliche Transformationen} genannt.
...
\begin{equation*}
\begin{tikzcd}
    A \arrow[rd, dotted] \arrow[r, red, "\phi"] & B \\
    & \color{red}{C}
\end{tikzcd}
\end{equation*}
