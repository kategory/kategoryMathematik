%******************************************************** -*-LaTeX-*- ******************************
%                                                                                                  *
%v5.0.1.1.4.5.1 Graphen sind Prägarben.tex                                                         *
%                                                                                                  *
% Copyright (C) 2024 Kategory GmbH \& Co. KG (joerg.kunze@kategory.de)                             *
%                                                                                                  *
% v5.0.1.1.4.5.1 Graphen sind Prägarben is part of kategoryMathematik.                             *
%                                                                                                  *
...
\textbf{v5.0.1.1.4.5.1 Graphen sind Prägarben}
}\\[1cm]
...
\subsection*{Inhalt}
%******************************************************************************************************
Ein Graph, genauer ein Multidigraph, ist eine Prägarbe über einer sehr einfachen Kategorie. Multidigraphen sind gerichtete (directed) Graphen mit parallelen Pfeilen und mit Schleifen.

Ferner ist die Kategorie der Mutidigraphen isomorph zu der entsprechenden Kategorie von Prägarben. Multidigraphen-Homomorphismen sind also natürliche Transformationen.

Damit erbt die Kategorie der Mutidigraphen alle schönen Eigenschaften von Prägarben-Kategorien, die wir im Verlaufe unseres leben kennenlernen.

Es zeigt auch, dass Prägarben-Kategorien keine Exoten sind.

Und es liefert eine Idee, wie wir uns Prägarben-Kategorien bildlich/geometrisch vorstellen können.
...
%******************************************************************************************************
Kategorie, Funktor, Natürliche Transformation, Funktor-Kategorie, Prägarben
...
\\
v5.0.1.1.4.5 (Höher) Kategorien - Prägarben\\
\url{https://youtu.be/yr8M3qihApQ}\\
\\
...
\url{https://de.wikipedia.org/wiki/Gerichteter_Graph}\\
\url{https://de.wikipedia.org/wiki/Graph_(Graphentheorie)#Multigraph}\\
\url{https://en.wikipedia.org/wiki/Multigraph}\\
\url{https://de.wikipedia.org/wiki/Schleife_(Graphentheorie)}
...
%******************************************************************************************************
%                                                                                                     *
\section{v5.0.1.1.4.5.1 Graphen sind Prägarben}
%                                                                                                     *
%******************************************************************************************************

%******************************************************************************************************
\subsection{Multidigraphs}
%******************************************************************************************************
