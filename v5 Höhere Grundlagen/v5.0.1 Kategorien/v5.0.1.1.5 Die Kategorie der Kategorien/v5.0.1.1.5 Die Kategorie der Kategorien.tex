%******************************************************** -*-LaTeX-*- ******************************
%                                                                                                  *
% v5.0.1.1.5 Die Kategorie der Kategorien.tex                                                      *
%                                                                                                  *
% Copyright (C) 2024 Kategory GmbH \& Co. KG (joerg.kunze@kategory.de)                             *
%                                                                                                  *
% v5.0.1.1.5 Die Kategorie der Kategorien is part of kategoryMathematik.                           *
%                                                                                                  *
...
\textbf{v5.0.1.1.5 Die Kategorie der Kategorien}
}\\[1cm]
...
\subsection*{Inhalt}
%******************************************************************************************************
Die Kategorie der kleinen Kategorien \textbf{Cat} besteht, wie wir schon wissen aus kleinen Kategorien als Objekte und Funktoren als Morphismen.

Diese Morphismen als Objekte mit den natürliche Transformationen als Morphismen ist selber wieder eine Kategorie. Hier haben wir Identitäten und Verknüpfungen von natürliche Transformationen.

Es gibt eine weitere Struktur in \textbf{Cat}: wir definieren eine andere Art der Verknüpfung von natürliche Transformationen, die eine Kategorie mit den kleinen Kategorien als Objekte und den natürliche Transformationen als Morphismen erzeugt.

Das heißt natürliche Transformationen wirken sowohl auf die Objekte von \textbf{Cat} als auch auf die Morphismen von \textbf{Cat}.

Darüber hinaus sind diese beiden Strukturen in der Hinsicht verträglich, dass sie über die selben Identitäten verfügen und dass die beiden in einer bestimmten Weise vertauschbar sind.

Die natürlichen Transformationen sind damit die Morphismen von zwei Kategorien: einmal mit den Funktoren und ein anderes Mal mit den Kategorien als Objekte.

Dies macht \textbf{Cat} zu einer 2-Kategorie mit natürliche Transformationen als 2-Morphismen.

Dies erlaubt uns einen ersten flüchtigen Blick auf 2-Kategorien.
...
%******************************************************************************************************
Natürliche Transformation, kleine Kategorien, Produkt von Kategorien, Funktorkategorien, kommutative Quadrate
...
{\tiny
   \url{https://github.com/kategory/kategoryMathematik/tree/main/v5%20H%C3%B6here%20Grundlagen/v5.0.1%20Kategorien/v5.0.1.1.5%20Die%20Kategorie%20der%20Kategorien}
}
...
\url{https://youtu.be/9K4qY5ZEoq8}\\
\\
...
\url{https://ncatlab.org/nlab/show/horizontal+composition}\\
\url{https://ncatlab.org/nlab/show/exchange+law}\\
\url{https://en.wikipedia.org/wiki/Category_of_small_categories}\\
\url{https://ncatlab.org/nlab/show/Cat}
...
%******************************************************************************************************
%                                                                                                     *
\section{v5.0.1.1.5 Die Kategorie der Kategorien}
%                                                                                                     *
%******************************************************************************************************
...
%******************************************************************************************************
Material is still on paper only :-(
