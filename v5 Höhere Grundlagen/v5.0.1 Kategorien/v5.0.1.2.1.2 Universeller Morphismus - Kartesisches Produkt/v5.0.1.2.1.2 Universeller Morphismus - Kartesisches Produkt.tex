%******************************************************** -*-LaTeX-*- ******************************
%                                                                                                  *
% v5.0.1.2.1.2 Universeller Morphismus - Kartesisches Produkt                                      *
%                                                                                                  *
% Copyright (C) 2025 Kategory GmbH \& Co. KG (joerg.kunze@kategory.de)                             *
%                                                                                                  *
% v5.0.1.2.1.2 Universeller Morphismus - Kartesisches Produkt is part of kategoryMathematik.       *
%                                                                                                  *
...
\textbf{v5.0.1.2.1.2 Universeller Morphismus - Kartesisches Produkt}
}\\[1cm]
...
\subsection*{Inhalt}
Das kartesische Produkt zweier Gruppen entpuppt sich als universeller Morphismus vom Diagonal-Funktor zu dem Paar der beiden Gruppen in der Kategorie der Gruppen-Paare.

Die Situation ist spiegelbildlich zu der in Video "`v5.0.1.2.1 (Höher) Kategorien - Funktor-Bilder"': dort haben wir gesehen, dass das Diagonal-Objekt, das Paar $(G,G)$, kouniverseller Morphismus von $G$ nach dem Produkt-Funktor ist.

\subsection*{Präsentiert}
Von Jörg Kunze

\subsection*{Voraussetzungen}
Kategorien, Funktoren, Funktor-Bilder, universeller Morphismus

\subsection*{Text}
Der Begleittext als PDF und als LaTeX findet sich unter
{\tiny
   \url{https://github.com/kategory/kategoryMathematik/tree/main/v5%20H%C3%B6here%20Grundlagen/v5.0.1%20Kategorien/v5.0.1.2.1.2%20Universeller%20Morphismus%20-%20Kartesisches%20Produkt}
}
...
%******************************************************************************************************
%                                                                                                     *
\section{v5.0.1.2.1.2 Universeller Morphismus - Kartesisches Produkt}
%                                                                                                     *
%******************************************************************************************************
(Noch nicht begonnen ...)
