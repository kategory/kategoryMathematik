%******************************************************** -*-LaTeX-*- ******************************
%                                                                                                  *
% v5.1.1.1.5.1 Direkte Summe vs Summe.tex                                                          *
%                                                                                                  *
% Copyright (C) 2025 Kategory GmbH \& Co. KG (joerg.kunze@kategory.de)                             *
%                                                                                                  *
% v5.1.1.1.5.1 Direkte Summe vs Summe is part of kategoryMathematik.                               *
%                                                                                                  *
...
\subsection*{Inhalt}
Neben der kategorisch definierten Summe als Kolimit (direkte Summe genannt) können wir im Falle zweier Unter-Moduln eines Moduls eine Summe der beiden auch als Menge aller Summen von je einem Element aus dem einen und einem aus dem anderen definieren. Dann erhalten wir ein neues Unter-Modul des Ausgangsmoduls. Wir bleiben also innerhalb des Moduls. Dies ist ein anderes Konzept die beiden Summen sind nie gleich und nur unter besonderen Bedingungen isomorph.
...
{\tiny
   \url{https://github.com/kategory/kategoryMathematik/tree/main/v5%20H%C3%B6here%20Grundlagen/v5.1%20Homologische%20Algebra/v5.1.1.1.5.1%20Direkte%20Summe%20vs%20Summe}
}
...
\url{https://proofwiki.org/wiki/Definition:Internal_Direct_Sum_of_Modules}\\
\url{https://ncatlab.org/nlab/show/internal+direct+sum}\\
\url{https://ncatlab.org/nlab/show/direct+sum}\\
