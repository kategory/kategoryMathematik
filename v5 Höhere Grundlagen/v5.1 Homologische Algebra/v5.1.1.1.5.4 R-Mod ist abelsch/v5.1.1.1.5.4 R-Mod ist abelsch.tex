%******************************************************** -*-LaTeX-*- ******************************
%                                                                                                  *
% v5.1.1.1.5.4 R-Mod ist abelsch.tex                                                               *
%                                                                                                  *
% Copyright (C) 2025 Kategory GmbH \& Co. KG (joerg.kunze@kategory.de)                             *
%                                                                                                  *
% v5.1.1.1.5.4 R-Mod ist abelsch is part of kategoryMathematik.                                    *
%                                                                                                  *
...
\textbf{v5.1.1.1.5.4 R-Mod ist abelsch}
}\\[1cm]
...
\subsection*{Inhalt}
Damit sich uns die Kategorie der $R$-Moduln als abelsch erweist, müssen wir noch das Axiom AK6 zeigen: Die Kategorie ist normal. D.h. alle Epi's und alle Mono's sind normal. D.h. jeder Epi ist ein Kokern und jeder Mono ist ein Kern.

Umgekehrt gilt das übrigens immer: jeder Kern ist Mono und jeder Kokern Epi.

Zum Beweis nutzen wir die in $R$-Mod vorhandene $(E,M)$-Faktorisierung (Epi-Mono-Faktorisierung): Jeder Morphismus $f$ lässt sich als $f = me$ schreiben. Bei $R$-Mod ist das Objekt zwischen $e$ und $m$ genau das Bild des Homomorphismuses.

Für dieses Bild gilt: Bild = Ker Koker = Koker Ker.

Damit beweisen wir schließlich das jeder Mono und jeder Epi normal ist.
...
\\
v5.1.1.1.4.5 (Höher) Homologische Algebra - Quotienten-Moduln\\
\url{https://youtu.be/IomDICJyHdI}\\
\\
...
\url{https://en.wikipedia.org/wiki/Abelian_category}\\
\url{https://en.wikipedia.org/wiki/Normal_morphism}\\
\url{https://en.wikipedia.org/wiki/Category_of_modules}\\
\url{}\\
\url{}\\
...
%******************************************************************************************************
%                                                                                                     *
\section{v5.1.1.1.5.4 R-Mod ist abelsch}
%                                                                                                     *
%******************************************************************************************************
