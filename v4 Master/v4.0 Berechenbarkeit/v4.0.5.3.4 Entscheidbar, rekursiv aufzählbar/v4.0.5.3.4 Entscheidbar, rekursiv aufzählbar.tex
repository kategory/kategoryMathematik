...
\begin{itemize}
   ...
   \item Das Prädikat ist dabei als wohldefiniert vorausgesetzt, es liefert also für jedes Element der Menge einen definierten Wahrheitswert.
   \item Es gibt nicht berechenbare Funktionen und somit nicht entscheidbare Mengen!
   \item Wir wollen Entscheidbarkeit von istTerm, istBeweis
   \item Ausblick: Wir haben keine Entscheidbarkeit von istBeweisbar!
\end{itemize}
