%******************************************************** -*-LaTeX-*- ******************************
%                                                                                                  *
% v4.0.4.3 Lambda-Kalkül.tex                                                                       *
%                                                                                                  *
% Copyright (C) 2024 Kategory GmbH \& Co. KG (joerg.kunze@kategory.de)                             *
%                                                                                                  *
% v4.0.4.3 Lambda-Kalkül is part of kategoryMathematik.                                            *
%                                                                                                  *
...
{\tiny
   \url{https://github.com/kategory/kategoryMathematik/tree/main/v4%20Master/v4.0%20Berechenbarkeit/v4.0.4.3%20Lambda-Kalk%C3%BCl}
}
...
%******************************************************************************************************
%                                                                                                     *
\section{v4.0.4.3 Lambda-Kalkül}
%                                                                                                     *
%******************************************************************************************************

\begin{itemize}
   \item Programmierkonstrukt, anonyme Funktion
   \item Funktionale Programmierung: das Manipulieren von Funktionen, Funktionen als Daten, als Rückgabewert
   \item Mu-rekursiv = lambda
   \item Alternative zur Def von berechenbar
   \item Mathematische Grundlagen: die 0 ist eine Funktion
