...
Berechenbare Funktionen, Turing-Maschinen, Gödel-Nummern, rekursiv aufzählbar, entscheidbar

\subsection*{Text}
Der Begleittext als PDF und als LaTeX findet sich unter
{\tiny
   \url{https://github.com/kategory/kategoryMathematik/tree/main/v4%20Master/v4.0%20Berechenbarkeit/v4.0.6.1%20Turingmaschinen-Nummer%20%3D%20Sourcecode}
}
...
\url{https://youtu.be/8eXhdnHMyUg}
\\
...
\url{https://en.wikipedia.org/wiki/Description_number}\\
